        ...
        $.ajax({
            ...
            success: function(result,status) {
                ...
                $('#userdropdowndetail').append(
                    ...
                    '                  <h5 class="modal-title" ><b>'+firstname+" "+lastname+' ( ' +gender +' ) </b><br> <span class="work">'+state+", " +city+", " +address+'<br><span><b>Rs. '+cost+'</b></span>/hour</br> '+skill +' for '+experiance+'<br></span></h5>' +
                    ...
                    '                      <div class="image-pad" >\n' +
                    '                        <img class="card-img-top-lg-5" src="file:///home/deepak/Downloads/Web API/Back End/uploads/'+image+'"\n' +
                    '                                                   alt="product" height="200px" width="200px" style="">\n' +
                    '                      </div>\n' +
                    '                    </div>\n' +
                    '                    <div class="col-sm-6 w-50" >\n' +
                    ...
                    '                         <div class="detail" ><button type="button" class="btn btn-info btn-sm">'+work +'</button></div>\n' +
                    '   <div class="detail" ><button type="button" class="btn btn-info btn-sm">'+pay +'</button></div>\n' +
                    '                          <div class="detail" ><span></span>'+((available==1)?'<span class="line-right">Available</span>':'<span class="line-wrong">Unavailable</span>')+' </div>\n' +
                    ...
                    '\n' +
                    '                          <button class="btn btn-danger favourite-button" id="btnhireme" uid="'+userid+'" ' +
                    ...
                    ' employeeid="'+ employeeid+'">Hire Now</button><br>\n' +
                    '                        </div>\n' +
                    '                    </div>\n' +
                    '                  </div>\n' +
                    '\n' +
    ...
    $.ajax({
        ...
        success:function(result,status){
            ...
            for (key in result){
                ...
                append('   <tr >\n' +
                    '                <td align="center">\n' +
                    '                  <img src="file:///home/deepak/Downloads/Web API/Back End/uploads/'+result[key].image +'" alt="worker image" height="100px" width="140px"></td>\n' +
