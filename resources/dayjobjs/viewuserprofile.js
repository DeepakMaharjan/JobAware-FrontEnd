    ...
    success:function(result,status){
        ...
        for (key in result){
            ...
            append('<div class="userdetailfloat col-lg-3 col-md-6 mb-4"> <div class="card">\n' +
                ...
                '<img class="card-img-top " src="file:///home/deepak/Downloads/Web API/Back End/uploads/'+result[key].image +'" alt="product" height="200px" width="200px"></a></div>\n' +
                '        ' +
                '            <div class="card-body">\n' +
                ...
                '             <input type="button" class="btn btn-danger favourite-button" uid="'+ result[key].userId + '" ' +
                ...
                'id="btnaddtofav" employeeid="'+ result[key].employeeId +'" name="btnfav"  value="Add to Favourite" >\n' +
                '            </div>\n' +
                '          </div> </div>')
        }
